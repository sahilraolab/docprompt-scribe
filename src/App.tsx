...
/* ---------------------------------------------
 * Enhanced ProtectedRoute (with roles & departments)
 * --------------------------------------------- */
...
//   if (departments && user && !departments.includes(user.department || "")) return <Navigate to="/403" replace />;

//   return <>{children}</>;
// }

/* ---------------------------------------------
 * Full App Component with All Modules
 * --------------------------------------------- */
const App = () => (
      ...
      <AuthProvider>
        <TooltipProvider>
          ...
          <Routes>
            ...
            <Route path="/purchase/comparative/:id/edit" element={<ProtectedRoute><AppLayout><ComparativeStatementForm /></AppLayout></ProtectedRoute>} />
