...
import { Building, FileText, FolderOpen, Calendar, Package, ListChecks } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Project management and documentation</p>
      </div>
